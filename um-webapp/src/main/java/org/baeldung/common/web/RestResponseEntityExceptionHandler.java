...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = { ConstraintViolationException.class, DataIntegrityViolationException.class, IllegalArgumentException.class, MyBadRequestException.class })
    ...
    public ResponseEntity<Object> handleCustom(final RuntimeException ex, final WebRequest request) {
    ...
    public ResponseEntity<Object> handleOther(final RuntimeException ex, final WebRequest request) {
        logger.error("500 Status Code", ex);
